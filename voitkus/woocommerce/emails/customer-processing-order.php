...
if ($plain_text) {
    ...
    echo esc_html__('Potwierdzamy przyjęcie zamówienia. Poniżej znajdziesz szczegóły transakcji.', 'voitkus') . "\n\n";
} else {
    if ($order->get_billing_first_name()) {
    ...
    echo '<p>' . esc_html__('Potwierdzamy przyjęcie zamówienia. Poniżej znajdziesz szczegóły transakcji.', 'voitkus') . '</p>';
}
